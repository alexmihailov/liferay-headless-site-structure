...
public abstract class BaseSiteStructureResourceImpl
	implements SiteStructureResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-headless-site-structure/v1.0/headless-site-structure/{siteId}/pages'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "SiteStructure")
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/headless-site-structure/{siteId}/pages")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/liferay-headless-site-structure/v1.0/headless-site-structure/{siteId}/pages/{friendlyUrlPath}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseSiteStructureResourceImpl.class);
