...
public class PageElement implements Serializable {
	...
	@Schema(description = "Name element.")
	...
	@GraphQLField(description = "Name element.")
	...
	@Schema(description = "A list of segments.")
	...
	public void setSegments(
		UnsafeSupplier<String[], Exception> segmentsUnsafeSupplier) {
	...
	@GraphQLField(description = "A list of segments.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(
		...
		defaultValue = "ru.tele2.liferay.headless.dto.v1_0.PageElement",
		name = "x-class-name"
	)
	...
	public static enum Type {
		...
		ROOT("Root"), SECTION("Section"), WIDGET("Widget");
